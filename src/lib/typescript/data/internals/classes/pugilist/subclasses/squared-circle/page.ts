...
export const page = createFightClub('squared-circle', 'The Squared Circle', 'A grappling-focused Pugilist who pins, controls, redirects attacks, and turns close contact into a finishing hold.', squaredCircleSections);
export default page;
