...
export const page = createFightClub('arena-royale', 'Arena Royale', 'A theatrical gladiator and performer who turns persona, crowd work, mobility, and signature moves into fight-winning spectacle.', arenaRoyaleSections);
export default page;
