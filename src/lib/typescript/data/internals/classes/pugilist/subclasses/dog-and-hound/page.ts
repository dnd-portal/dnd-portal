...
export const page = createFightClub('dog-and-hound', 'Dog & Hound', 'A loyal brawler who fights beside a canine companion and shares moxie, attacks, and battlefield pressure with their hound.', dogAndHoundSections);
export default page;
