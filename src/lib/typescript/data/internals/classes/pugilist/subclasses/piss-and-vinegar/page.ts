...
export const page = createFightClub('piss-and-vinegar', 'Piss & Vinegar', 'A dirty-trick heel who uses insults, provocation, psychic pressure, and spiteful tricks to make enemies fight badly.', pissAndVinegarSections);
export default page;
