...
export const page = createFightClub('sweet-science', 'The Sweet Science', 'A boxing-focused Pugilist who blocks, counters, chains fast strikes, regains momentum, and looks for the knockout.', sweetScienceSections);
export default page;
