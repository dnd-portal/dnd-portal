import {
	...
	link,
	text
} from '$lib/typescript/data/internals/classes/_basic-class';
...
export const page = createFightClub('bloodhound-bruisers', 'Bloodhound Bruisers', 'An urban hunter and investigator who reads people, finds trouble, and uses city familiarity to stay one step ahead.', bloodhoundBruisersSections);
export default page;
