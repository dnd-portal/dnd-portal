...
export const page = createShinobiPath('paths', 'Shinobi Paths', 'Specialized disciplines that determine how a Shinobi applies martial training and chakra.', pathsOverviewSections);
export default page;
