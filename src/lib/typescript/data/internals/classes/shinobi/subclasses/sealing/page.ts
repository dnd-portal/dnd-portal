...
export const page = createShinobiPath('path-of-sealing', 'Path of Sealing', 'Restraining, binding, storing, and suppressing effects through sealing arts.', sealingSections);
export default page;
