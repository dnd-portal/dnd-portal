...
export const page = createShinobiPath('path-of-the-bloodline', 'Path of the Bloodline', 'Inherited power that changes the Shinobi through a distinct bloodline gift.', bloodlineSections);
export default page;
