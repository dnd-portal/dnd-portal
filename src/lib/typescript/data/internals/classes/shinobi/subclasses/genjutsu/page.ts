...
export const page = createShinobiPath('path-of-genjutsu', 'Path of Genjutsu', 'Illusion, misdirection, and mental pressure expressed through chakra.', genjutsuSections);
export default page;
