...
export const page = createShinobiPath('path-of-elemental-ninjutsu', 'Path of Elemental Ninjutsu', 'Elemental chakra techniques focused on offensive and environmental control.', elementalSections);
export default page;
