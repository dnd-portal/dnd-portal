...
export const page = createShinobiPath('path-of-taijutsu', 'Path of Taijutsu', 'Close-quarters physical technique, mobility, and disciplined body control.', taijutsuSections);
export default page;
