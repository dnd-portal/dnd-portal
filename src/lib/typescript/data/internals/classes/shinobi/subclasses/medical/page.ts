...
export const page = createShinobiPath('path-of-the-medical-shinobi', 'Path of the Medical Shinobi', 'Healing, stabilization, and precise chakra control used to keep allies alive.', medicalSections);
export default page;
